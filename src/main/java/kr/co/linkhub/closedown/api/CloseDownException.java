 ...
 * @version 1.0.0
 */
public class CloseDownException extends Exception {
	private static final long serialVersionUID = 1L;

	private long code;

	public CloseDownException(LinkhubException linkhubException) {
	...
	public CloseDownException(long code, String Message, Throwable innerException) {
